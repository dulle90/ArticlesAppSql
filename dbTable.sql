...
/****** Object:  Database [Articles]    Script Date: 29.8.2019 16:36:26 ******/
CREATE DATABASE [Articles]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Articles', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Articles.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Articles_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MSSQLSERVER\MSSQL\DATA\Articles_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [Articles] SET COMPATIBILITY_LEVEL = 140
GO

IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Articles].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
...
ALTER DATABASE [Articles] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO

ALTER DATABASE [Articles] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [Articles] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [Articles] SET QUERY_STORE = OFF
GO
